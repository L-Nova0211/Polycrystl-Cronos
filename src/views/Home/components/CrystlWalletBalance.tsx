...
const CrystlWalletBalance = () => {
  ...
  const { balance: croBalance } = useGetBnbBalance() // useTokenBalance(getCrtAddress())
  /* const crystlPriceBusd = usePriceCrystlBusd()
  const busdBalance = new BigNumber(getBalanceNumber(croBalance)).multipliedBy(crystlPriceBusd).toNumber() */
