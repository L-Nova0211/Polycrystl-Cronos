...
export const fetchPublicVaultData = async () => {
  try {
    ...
    return {
      ...
      estimatedCrystlBountyReward: new BigNumber(estimatedCrystlBountyReward as string).toJSON(),
      totalPendingCrystlHarvest: new BigNumber(totalPendingCrystlHarvest as string).toJSON(),
    }
  } catch (error) {
    return {
      totalShares: null,
